    ...
    <>
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row lg:flex-row shadow-md ">
                  ...
                  >
                    {({
                      ...
                      <form>
                        ...
                        >
                          <Flex flexDirection={"column"}>
                            ...
                            {errors.landmark && touched.landmark && (
                              <InputError text={errors.landmark} />
                            )}
                          </Flex>
                          <Flex flexDirection={"column"}>
                            <label
                        ...
                        >
                          ...
                          <Flex flexDirection={"column"}>
                            ...
                            {errors.pincode && touched.pincode && (
                              <InputError text={errors.pincode} />
                            )}
                          </Flex>
                        </Grid>
                        <div className="mt-5">
                        ...
                        {errors.paymode && touched.paymode && (
                          <InputError text={errors.paymode} />
                        )}
                        <Button
          ...
          <div
            id="summary"
            className="bg-primary-100 w-4/4 md:w-1/4 lg:w-1/4 px-8 mb-18 py-10"
          >
